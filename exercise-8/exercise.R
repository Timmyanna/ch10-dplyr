...
pupulitzer_circulation <- read.csv("data/pulitzer-circulation-data.csv", 
...
# 2004-2014?
filter(pupulitzer_circulation, Pulitzer.Prize.Winners.and.Finalists..2004.2014
